...
-  **Select Features** and preprocessing options  
...
if data is not None:
    ...
    with tab1:
        ...
        if len(numerical_cols) == 0:
            st.warning(" No Numerical columns found. Regression cannot be performed.")
        else:
    ...
    with tab2:
        ...
        if len(categorical_cols) == 0:
            st.warning(" No categorical columns found. Classification cannot be performed.")
        else:
